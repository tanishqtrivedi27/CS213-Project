...
<?php
    ...
    $sql = "SELECT * FROM `product` WHERE keywords LIKE '%".$search_query."%' ";
...
<div class="main-search-content">
  ...
  <div class="sort">
    ...
    <form action="<?php echo htmlspecialchars("./filtered-search.php");?>" method="POST">
  ...
  <div class="list-items">
    ...
    <h2 class="text-xl font-semibold">RESULTS FOR <?php echo $search_query;?></h2>
    <br>
